...
let ingridCount = 0;             // Counter untuk ID unik in-grid ads
...
// =====================================================
const KATEGORI_LIST = [
    { label: 'Indonesia', query: 'indonesia', img: 'https://static-sg-cdn.eporner.com/catimg/80.jpg', order: 'most-popular', slug: 'indonesia' },
    { label: 'Japanese', query: 'japanese', img: 'https://static-sg-cdn.eporner.com/catimg/52.jpg', order: 'most-popular', slug: 'japanese' },
    { label: 'Asian', query: 'asian', img: 'https://static-sg-cdn.eporner.com/catimg/11.jpg', order: 'most-popular', slug: 'asian' },
    { label: '60 FPS', query: '60 fps', img: 'https://static-sg-cdn.eporner.com/catimg/67.jpg', order: 'most-popular', slug: '60-fps' },
    { label: 'AI', query: 'ai', img: 'https://static-sg-cdn.eporner.com/catimg/73.jpg', order: 'most-popular', slug: 'ai' },
    { label: 'Amateur', query: 'amateur', img: 'https://static-sg-cdn.eporner.com/catimg/1.jpg', order: 'most-popular', slug: 'amateur' },
    { label: 'Anal', query: 'anal', img: 'https://static-sg-cdn.eporner.com/catimg/3.jpg', order: 'most-popular', slug: 'anal' },
    { label: 'ASMR', query: 'asmr', img: 'https://static-sg-cdn.eporner.com/catimg/31.jpg', order: 'most-popular', slug: 'asmr' },
    { label: 'BBW', query: 'bbw', img: 'https://static-sg-cdn.eporner.com/catimg/63.jpg', order: 'most-popular', slug: 'bbw' },
    { label: 'BDSM', query: 'bdsm', img: 'https://static-sg-cdn.eporner.com/catimg/29.jpg', order: 'most-popular', slug: 'bdsm' },
    { label: 'Big Ass', query: 'big ass', img: 'https://static-sg-cdn.eporner.com/catimg/44.jpg', order: 'most-popular', slug: 'big-ass' },
    { label: 'Big Dick', query: 'big dick', img: 'https://static-sg-cdn.eporner.com/catimg/7.jpg', order: 'most-popular', slug: 'big-dick' },
    { label: 'Big Tits', query: 'big tits', img: 'https://static-sg-cdn.eporner.com/catimg/25.jpg', order: 'most-popular', slug: 'big-tits' },
    { label: 'Bisexual', query: 'bisexual', img: 'https://static-sg-cdn.eporner.com/catimg/46.jpg', order: 'most-popular', slug: 'bisexual' },
    { label: 'Blonde', query: 'blonde', img: 'https://static-sg-cdn.eporner.com/catimg/37.jpg', order: 'most-popular', slug: 'blonde' },
    { label: 'Blowjob', query: 'blowjob', img: 'https://static-sg-cdn.eporner.com/catimg/8.jpg', order: 'most-popular', slug: 'blowjob' },
    { label: 'Bondage', query: 'bondage', img: 'https://static-sg-cdn.eporner.com/catimg/45.jpg', order: 'most-popular', slug: 'bondage' },
    { label: 'Brunette', query: 'brunette', img: 'https://static-sg-cdn.eporner.com/catimg/38.jpg', order: 'most-popular', slug: 'brunette' },
    { label: 'Bukkake', query: 'bukkake', img: 'https://static-sg-cdn.eporner.com/catimg/55.jpg', order: 'most-popular', slug: 'bukkake' },
    { label: 'Casting', query: 'casting', img: 'https://static-sg-cdn.eporner.com/catimg/74.jpg', order: 'most-popular', slug: 'casting' },
    { label: 'Compilation', query: 'compilation', img: 'https://static-sg-cdn.eporner.com/catimg/75.jpg', order: 'most-popular', slug: 'compilation' },
    { label: 'Cosplay', query: 'cosplay', img: 'https://static-sg-cdn.eporner.com/catimg/76.jpg', order: 'most-popular', slug: 'cosplay' },
    { label: 'Creampie', query: 'creampie', img: 'https://static-sg-cdn.eporner.com/catimg/47.jpg', order: 'most-popular', slug: 'creampie' },
    { label: 'Cuckold', query: 'cuckold', img: 'https://static-sg-cdn.eporner.com/catimg/77.jpg', order: 'most-popular', slug: 'cuckold' },
    { label: 'Cumshot', query: 'cumshot', img: 'https://static-sg-cdn.eporner.com/catimg/4.jpg', order: 'most-popular', slug: 'cumshot' },
    { label: 'Doctor', query: 'doctor', img: 'https://static-sg-cdn.eporner.com/catimg/34.jpg', order: 'most-popular', slug: 'doctor' },
    { label: 'Double Penetration', query: 'double penetration', img: 'https://static-sg-cdn.eporner.com/catimg/2.jpg', order: 'most-popular', slug: 'double-penetration' },
    { label: 'Ebony', query: 'ebony', img: 'https://static-sg-cdn.eporner.com/catimg/10.jpg', order: 'most-popular', slug: 'ebony' },
    { label: 'Fat', query: 'fat', img: 'https://static-sg-cdn.eporner.com/catimg/18.jpg', order: 'most-popular', slug: 'fat' },
    { label: 'Fetish', query: 'fetish', img: 'https://static-sg-cdn.eporner.com/catimg/60.jpg', order: 'most-popular', slug: 'fetish' },
    { label: 'Fisting', query: 'fisting', img: 'https://static-sg-cdn.eporner.com/catimg/56.jpg', order: 'most-popular', slug: 'fisting' },
    { label: 'Footjob', query: 'footjob', img: 'https://static-sg-cdn.eporner.com/catimg/40.jpg', order: 'most-popular', slug: 'footjob' },
    { label: 'For Women', query: 'for women', img: 'https://static-sg-cdn.eporner.com/catimg/64.jpg', order: 'most-popular', slug: 'for-women' },
    { label: 'Gloryhole', query: 'gloryhole', img: 'https://static-sg-cdn.eporner.com/catimg/78.jpg', order: 'most-popular', slug: 'gloryhole' },
    { label: 'Group Sex', query: 'group sex', img: 'https://static-sg-cdn.eporner.com/catimg/26.jpg', order: 'most-popular', slug: 'group-sex' },
    { label: 'Handjob', query: 'handjob', img: 'https://static-sg-cdn.eporner.com/catimg/21.jpg', order: 'most-popular', slug: 'handjob' },
    { label: 'Hardcore', query: 'hardcore', img: 'https://static-sg-cdn.eporner.com/catimg/5.jpg', order: 'most-popular', slug: 'hardcore' },
    { label: 'HD Porn 1080p', query: 'hd porn 1080p', img: 'https://static-sg-cdn.eporner.com/catimg/43.jpg', order: 'most-popular', slug: 'hd-porn-1080p' },
    { label: 'HD Sex', query: 'hd sex', img: 'https://static-sg-cdn.eporner.com/catimg/70.jpg', order: 'most-popular', slug: 'hd-sex' },
    { label: 'Hentai', query: 'hentai', img: 'https://static-sg-cdn.eporner.com/catimg/42.jpg', order: 'most-popular', slug: 'hentai' },
    { label: 'Homemade', query: 'homemade', img: 'https://static-sg-cdn.eporner.com/catimg/12.jpg', order: 'most-popular', slug: 'homemade' },
    { label: 'Hotel', query: 'hotel', img: 'https://static-sg-cdn.eporner.com/catimg/35.jpg', order: 'most-popular', slug: 'hotel' },
    { label: 'Hotwife', query: 'hotwife', img: 'https://static-sg-cdn.eporner.com/catimg/79.jpg', order: 'most-popular', slug: 'hotwife' },
    { label: 'Housewives', query: 'housewives', img: 'https://static-sg-cdn.eporner.com/catimg/20.jpg', order: 'most-popular', slug: 'housewives' },
    { label: 'HQ Porn', query: 'hq porn', img: 'https://static-sg-cdn.eporner.com/catimg/69.jpg', order: 'most-popular', slug: 'hq-porn' },
    { label: 'Indian', query: 'indian', img: 'https://static-sg-cdn.eporner.com/catimg/59.jpg', order: 'most-popular', slug: 'indian' },
    { label: 'Interracial', query: 'interracial', img: 'https://static-sg-cdn.eporner.com/catimg/48.jpg', order: 'most-popular', slug: 'interracial' },
    { label: 'Latina', query: 'latina', img: 'https://static-sg-cdn.eporner.com/catimg/54.jpg', order: 'most-popular', slug: 'latina' },
    { label: 'Lesbian', query: 'lesbian', img: 'https://static-sg-cdn.eporner.com/catimg/6.jpg', order: 'most-popular', slug: 'lesbian' },
    { label: 'Lingerie', query: 'lingerie', img: 'https://static-sg-cdn.eporner.com/catimg/36.jpg', order: 'most-popular', slug: 'lingerie' },
    { label: 'Massage', query: 'massage', img: 'https://static-sg-cdn.eporner.com/catimg/49.jpg', order: 'most-popular', slug: 'massage' },
    { label: 'Masturbation', query: 'masturbation', img: 'https://static-sg-cdn.eporner.com/catimg/28.jpg', order: 'most-popular', slug: 'masturbation' },
    ...
    { label: 'Nurses', query: 'nurses', img: 'https://static-sg-cdn.eporner.com/catimg/41.jpg', order: 'most-popular', slug: 'nurses' },
    { label: 'Office', query: 'office', img: 'https://static-sg-cdn.eporner.com/catimg/23.jpg', order: 'most-popular', slug: 'office' },
    { label: 'Older Men', query: 'older men', img: 'https://static-sg-cdn.eporner.com/catimg/13.jpg', order: 'most-popular', slug: 'older-men' },
    { label: 'Orgy', query: 'orgy', img: 'https://static-sg-cdn.eporner.com/catimg/58.jpg', order: 'most-popular', slug: 'orgy' },
    { label: 'Outdoor', query: 'outdoor', img: 'https://static-sg-cdn.eporner.com/catimg/16.jpg', order: 'most-popular', slug: 'outdoor' },
    { label: 'PAWG', query: 'pawg', img: 'https://static-sg-cdn.eporner.com/catimg/81.jpg', order: 'most-popular', slug: 'pawg' },
    { label: 'Petite', query: 'petite', img: 'https://static-sg-cdn.eporner.com/catimg/65.jpg', order: 'most-popular', slug: 'petite' },
    { label: 'Pinay', query: 'pinay', img: 'https://static-sg-cdn.eporner.com/catimg/82.jpg', order: 'most-popular', slug: 'pinay' },
    { label: 'Pornstar', query: 'pornstar', img: 'https://static-sg-cdn.eporner.com/catimg/66.jpg', order: 'most-popular', slug: 'pornstar' },
    { label: 'POV', query: 'pov', img: 'https://static-sg-cdn.eporner.com/catimg/33.jpg', order: 'most-popular', slug: 'pov' },
    { label: 'Pregnant', query: 'pregnant', img: 'https://static-sg-cdn.eporner.com/catimg/83.jpg', order: 'most-popular', slug: 'pregnant' },
    { label: 'Public', query: 'public', img: 'https://static-sg-cdn.eporner.com/catimg/15.jpg', order: 'most-popular', slug: 'public' },
    { label: 'Redhead', query: 'redhead', img: 'https://static-sg-cdn.eporner.com/catimg/39.jpg', order: 'most-popular', slug: 'redhead' },
    { label: 'Shemale', query: 'shemale', img: 'https://static-sg-cdn.eporner.com/catimg/24.jpg', order: 'most-popular', slug: 'shemale' },
    { label: 'Sleep', query: 'sleep', img: 'https://static-sg-cdn.eporner.com/catimg/22.jpg', order: 'most-popular', slug: 'sleep' },
    { label: 'Small Tits', query: 'small tits', img: 'https://static-sg-cdn.eporner.com/catimg/50.jpg', order: 'most-popular', slug: 'small-tits' },
    { label: 'Squirt', query: 'squirt', img: 'https://static-sg-cdn.eporner.com/catimg/51.jpg', order: 'most-popular', slug: 'squirt' },
    { label: 'Stepmom', query: 'stepmom', img: 'https://static-sg-cdn.eporner.com/catimg/84.jpg', order: 'most-popular', slug: 'stepmom' },
    { label: 'Stepsister', query: 'stepsister', img: 'https://static-sg-cdn.eporner.com/catimg/85.jpg', order: 'most-popular', slug: 'stepsister' },
    { label: 'Striptease', query: 'striptease', img: 'https://static-sg-cdn.eporner.com/catimg/61.jpg', order: 'most-popular', slug: 'striptease' },
    { label: 'Students', query: 'couple', img: 'https://static-sg-cdn.eporner.com/catimg/19.jpg', order: 'most-popular', slug: 'couple' },
    { label: 'Swinger', query: 'swinger', img: 'https://static-sg-cdn.eporner.com/catimg/32.jpg', order: 'most-popular', slug: 'swinger' },
    { label: 'Teen', query: 'babe', img: 'https://static-sg-cdn.eporner.com/catimg/0.jpg', order: 'most-popular', slug: 'babe' },
    { label: 'Threesome', query: 'threesome', img: 'https://static-sg-cdn.eporner.com/catimg/9.jpg', order: 'most-popular', slug: 'threesome' },
    { label: 'Toys', query: 'toys', img: 'https://static-sg-cdn.eporner.com/catimg/30.jpg', order: 'most-popular', slug: 'toys' },
    { label: 'Uniform', query: 'uniform', img: 'https://static-sg-cdn.eporner.com/catimg/27.jpg', order: 'most-popular', slug: 'uniform' },
    { label: 'Vintage', query: 'vintage', img: 'https://static-sg-cdn.eporner.com/catimg/57.jpg', order: 'most-popular', slug: 'vintage' },
    { label: 'VR Porn', query: 'vr porn', img: 'https://static-sg-cdn.eporner.com/catimg/72.jpg', order: 'most-popular', slug: 'vr-porn' },
    { label: 'Webcam', query: 'webcam', img: 'https://static-sg-cdn.eporner.com/catimg/62.jpg', order: 'most-popular', slug: 'webcam' },
];
